...
const LifeInsuranceClaimForm = () => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
      <Text style={styles.header}>Life Insurance Claim Form</Text>
      ...
      <TouchableOpacity
        ...
        onPress={() => handleDocumentSelection('Death Certificate')}
      >
        <Text style={styles.uploadButtonText}>Upload Death Certificate</Text>
      </TouchableOpacity>
      
      <TouchableOpacity
        style={styles.uploadButton}
        onPress={() => handleDocumentSelection('Medical Reports')}
      >
      ...
      <TouchableOpacity
        style={styles.uploadButton}
        onPress={() => handleDocumentSelection('Police Report')}
      >
...
export default LifeInsuranceClaimForm;
