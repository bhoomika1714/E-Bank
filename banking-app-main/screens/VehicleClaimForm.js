...
const VehicleClaimForm = () => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
      <Text style={styles.header}>Vehicle Insurance Claim Form</Text>
      ...
      <TextInput style={styles.input} placeholder="Vehicle Year" />
      <TextInput style={styles.input} placeholder="License Plate Number" />
      <TextInput style={styles.input} placeholder="VIN (Vehicle Identification Number)" />
...
export default VehicleClaimForm;
